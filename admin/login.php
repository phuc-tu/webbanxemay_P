...
if(isset($_POST['dangnhap'])){
    ...
    // Truy vấn tìm tài khoản đúng và lấy luôn quyền admin_status
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        // Lưu thông tin đăng nhập và phân quyền vào session
        $_SESSION['dangnhap'] = $data['username'];
        $_SESSION['admin_status'] = $data['admin_status'];
        header("Location: index.php");   // Chuyển về trang chủ admin sau khi đăng nhập
        exit();
    } else {
        echo '<script>
...
<div class="wrapper">
  ...
  <div class="signup-wrapper text-center">
    <a href="#">Don't have an account? <span class="text-primary">Create One</span></a>
  </div>
</div>
